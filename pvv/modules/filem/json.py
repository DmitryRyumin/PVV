...
# Персональные
from pvv.modules.filem.file_manager import FileManager  # Работа с файлами
...
class Messages(FileManager):
    ...
    def __init__(self):
        ...
        self._load_data_resources_not_found = '    ' + self._('[{}{}{}] Ресурс не найден ...')
        self._invalid_file = '    ' + self._('[{}{}{}] Данные не загружены ...')
        self._config_empty = '    ' + self._('[{}{}{}] Файл пуст ...')
...
class Json(Messages):
    ...
    # Рекурсивное отображение данных из JSON файла
