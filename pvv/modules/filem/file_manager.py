...
# Персональные
from pvv.modules.core import core  # Ядро
...
class Messages(core.Core):
    ...
    def __init__(self):
        ...
        self._file_name = '    ' + self._('[{}{}{}] Необходимо указать название {} файла ...')
        self._dir_found = '    ' + self._('[{}{}{}] Передана директория за место файла ...')
        self._file_not_found = '    ' + self._('[{}{}{}] Файл "{}" не найден ...')
        self._file_not_found_create = '    ' + self._('[{}] Файл "{}" не найден, но был создан ...')
        self._wrong_extension = '    ' + self._('[{}{}{}] Расширение файла должно быть "{}" ...')

        self._clear_folder = self._('[{}] Очистка директории "{}" ...')
        self._clear_folder_not_found = '    ' + self._('[{}{}{}] Директория "{}" не найдена ...')

        self._load_data = '    ' + self._('[{}] Загрузка данных из файла "{}" ...')
